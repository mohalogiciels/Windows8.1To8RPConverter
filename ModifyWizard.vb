...
Public Class ModifyWizard
    ...
    Public IsThemeChangeNeeded As Boolean
    Public IsRestartNeeded As Boolean
    Public ChangeONEChecked As Boolean = False
    Public ChangeUXMethodChecked As Boolean = False
    Public ChangeQueroChecked As Boolean = False
    Public ChangeSysFilesChecked As Boolean = False
    Public InstallSoundsChecked As Boolean = False
    Public ChangeGadgetsChecked As Boolean = False
    Public ChangeToSelected As String
    ...
    Private Sub ModifyWizard_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ...
        If IsSelectedLanguageDisplayLanguage = True Then
        ...
        '    Me.Hide()
        '    ModifyThemeSelectDeutsch.show()
        If Language = "en-US" Or Language = "en-GB" Then
            Me.Hide()
            ModifyThemeSelectEnglish.Show()
            'ElseIf Language = "es-ES" Then
            '    Me.Hide()
            '    ModifyThemeSelectEspanol.show()
            'ElseIf Language = "fr-FR" Then
            '    Me.Hide()
            '    ModifyThemeSelectFrancais.show()
            'ElseIf Language = "it-IT" Then
            '    Me.Hide()
            '    ModifyThemeSelectItalian.show()
            'ElseIf Language = "nl-NL" Then
            '    Me.Hide()
            '    ModifyThemeSelectNederlands.show()
            'ElseIf Language = "pt-BR" Then
            '    Me.Hide()
            '    ModifyThemeSelectPortuguesBrasil.show()
            'ElseIf Language = "pt-PT" Then
            '    Me.Hide()
            '    ModifyThemeSelectPortuguesPortugal.show()
            'ElseIf Language = "ko-KR" Then
            '    Me.Hide()
            '    ModifyThemeSelectKorean.show()
            'ElseIf Language = "ru-RU" Then
            '    Me.Hide()
            '    ModifyThemeSelectRussian.show()
            'ElseIf Language = "uk-UA" Then
            '    Me.Hide()
            '    ModifyThemeSelectUkrainian.show()
        Else
            '!!temporary code!!
            Me.Close()
        End If
