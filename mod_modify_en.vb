...
Public Class mod_modify_en
    ...
    Private Sub mod_modify_en_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBarMod.Style = ProgressBarStyle.Marquee
        ProgressBarMod.MarqueeAnimationSpeed = 100
    End Sub

    Private Sub mod_modify_en_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ' Initialise progress bar
        If modify.ChangeONEChecked = True Then
            ProgBarCounter = ProgBarCounter + 10
        End If
        If modify.ChangeUXMethodChecked = True Then
            ProgBarCounter = ProgBarCounter + 20
        End If
        If modify.ChangeQueroChecked = True Then
            ProgBarCounter = ProgBarCounter + 10
        End If
        If modify.ChangeSysFilesChecked = True Then
            ProgBarCounter = ProgBarCounter + 10
        End If
        If modify.InstallSoundsChecked = True Then
            ProgBarCounter = ProgBarCounter + 10
        End If
        If modify.ChangeGadgetsChecked = True Then
            ProgBarCounter = ProgBarCounter + 10
        End If
        If modify.MenuChAddBarStyle = True Then
            ProgBarCounter = ProgBarCounter + 10
        End If

        ' Check if theme change is needed
        If modify.IsThemeChangeNeeded = True Then
            Me.TopMost = True
            BgWorker.RunWorkerAsync()
        ElseIf modify.IsThemeChangeNeeded = False Then
            ' \Initialise progress bar
            With ProgressBarMod
    ...
    Private Sub ModifyInstall()
            ...
            If modify.InstONE = True Then
                ...
                If modify.BitnessSystem = "64bit" Then
                    ...
                    With ONESetup
                        ...
                        .WaitForExit()
                    End With
                ElseIf modify.BitnessSystem = "32bit" Then
                    With ONESetup
                        .StartInfo.FileName = WinDir & "\System32\regsvr32.exe"
                        .StartInfo.Arguments = "/u /s """ & DestPathONE & "\OldNewExplorer32.dll"""
                        .Start()
                ...
                ActionLabel.Refresh()
            ElseIf modify.InstONE = False Then
        ...
        If modify.ChangeUXMethodChecked = True Then
            If modify.InstUX = "UltraUX" Then
                ...
                ActionLabel.Refresh()
            ElseIf modify.InstUX = "UXTSB" Then
        ...
        ' Install/uninstall Quero Toolbar
        If modify.ChangeQueroChecked = True And Not FileIO.FileSystem.DirectoryExists(ProgramFiles & "\Quero Toolbar") Then
            ...
            If modify.BitnessSystem = "64bit" Then
                With QueroSetup
                    ...
                    .StartInfo.Arguments = "/SILENT /LOADINF=""settings.inf"""
                    .Start()
                    .WaitForExit()
                End With
            ElseIf modify.BitnessSystem = "32bit" Then
                ...
                End With
            End If
            File.WriteAllBytes(ResFolder & "\modify.xht", My.Resources.modify_en_quero)
            If modify.IsRestartNeeded = True Then
                Dim AutorunRegKey = Registry.CurrentUser.OpenSubKey("Software\Microsoft\Windows\CurrentVersion\RunOnce", True)
                AutorunRegKey.SetValue("win8rpconv_modify", """" & ProgramFiles & "\Internet Explorer\iexplore.exe"" " & """" & ResFolder & "\modify.xht""", RegistryValueKind.String)
                AutorunRegKey.Close()
            End If
            ProgressBarMod.PerformStep()
            ProgressBarMod.Refresh()
            ...
            ActionLabel.Refresh()
        ElseIf modify.ChangeQueroChecked = True And FileIO.FileSystem.DirectoryExists(ProgramFiles & "\Quero Toolbar") Then
            Dim QueroSetup As New Process
        ...
        If modify.InstSysFiles = True And modify.ChangeSysFilesChecked Then
            ...
            If modify.BitnessSystem = "64bit" Then
                ...
                If FileIO.FileSystem.FileExists(WinDir & "\System32\UIRibbon.dll.bak") And FileIO.FileSystem.FileExists(WinDir & "\System32\UIRibbonRes.dll.bak") And FileIO.FileSystem.FileExists(WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui.bak") And FileIO.FileSystem.FileExists(WinDir & "\SysWOW64\UIRibbon.dll.bak") And FileIO.FileSystem.FileExists(WinDir & "\SysWOW64\UIRibbonRes.dll.bak") And FileIO.FileSystem.FileExists(WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui.bak") Then
                    ...
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\takeown.exe"
                        .StartInfo.Arguments = "/f " & WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui /a"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui /grant *S-1-5-32-545:F *S-1-5-32-544:F"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\takeown.exe"
                        .StartInfo.Arguments = "/f " & WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui.bak /a"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui.bak /grant *S-1-5-32-545:F *S-1-5-32-544:F"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    FileIO.FileSystem.DeleteFile(WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui")
                    FileIO.FileSystem.RenameFile(WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui.bak", "UIRibbon.dll.mui")
                    ...
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui /setowner ""NT SERVICE\TrustedInstaller"""
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui /reset"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui /grant *S-1-5-18:RX *S-1-5-32-544:RX *S-1-5-32-545:RX *S-1-15-2-1:RX ""NT SERVICE\TrustedInstaller"":F /inheritance:r"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    ...
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\takeown.exe"
                        .StartInfo.Arguments = "/f " & WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui /a"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui /grant *S-1-5-32-545:F *S-1-5-32-544:F"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\takeown.exe"
                        .StartInfo.Arguments = "/f " & WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui.bak /a"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui.bak /grant *S-1-5-32-545:F *S-1-5-32-544:F"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    FileIO.FileSystem.DeleteFile(WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui")
                    FileIO.FileSystem.RenameFile(WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui.bak", "UIRibbon.dll.mui")
                    ' \Original files change to TrustedInstaller
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                    ...
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui /setowner ""NT SERVICE\TrustedInstaller"""
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui /reset"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    With SysFilesSetup
                        .StartInfo.FileName = WinDir & "\System32\icacls.exe"
                        .StartInfo.Arguments = WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui /grant *S-1-5-18:RX *S-1-5-32-544:RX *S-1-5-32-545:RX *S-1-15-2-1:RX ""NT SERVICE\TrustedInstaller"":F /inheritance:r"
                        .StartInfo.WindowStyle = ProcessWindowStyle.Hidden
                        .Start()
                        .WaitForExit()
                    End With
                    ...
                    ActionLabel.Refresh()
                    ' \Start userinit.exe
                    mod_modify_ExplorerStartInfoWindow_en.Show()
                    ...
                    With StartExplorerTask
                        ...
                        .WaitForExit()
                    End With
                    mod_modify_ExplorerStartInfoWindow_en.Dispose()
                Else
                ...
                End If
            ElseIf modify.BitnessSystem = "32bit" Then
                If FileIO.FileSystem.FileExists(WinDir & "\System32\UIRibbon.dll.bak") And FileIO.FileSystem.FileExists(WinDir & "\System32\UIRibbonRes.dll.bak") And FileIO.FileSystem.FileExists(WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui.bak") Then
                    ' \End explorer.exe task
                    Dim EndExplorerTask As New Process
                    With EndExplorerTask
                        .StartInfo.FileName = WinDir & "\System32\taskkill.exe"
                ...
                End If
            End If
        ElseIf modify.InstSysFiles = False And modify.ChangeSysFilesChecked Then
            Dim SysFilesSetup As New Process
            ...
            If modify.BitnessSystem = "64bit" Then
                ...
                With SysFilesSetup
                    ...
                    .WaitForExit()
                End With
                FileIO.FileSystem.RenameFile(WinDir & "\System32\" & modify.Language & "\UIRibbon.dll.mui", "UIRibbon.dll.mui.bak")
                ...
                With SysFilesSetup
                    ...
                    .WaitForExit()
                End With
                FileIO.FileSystem.RenameFile(WinDir & "\SysWOW64\" & modify.Language & "\UIRibbon.dll.mui", "UIRibbon.dll.mui.bak")
        ...
        ' Install/uninstall 8GadgetPack
        If modify.ChangeGadgetsChecked = True Then
            If modify.InstGadgets = True And FileIO.FileSystem.FileExists(ProgramFiles & "\Windows Sidebar\8GadgetPack.exe") Then
                ...
                ActionLabel.Refresh()
            ElseIf modify.InstGadgets = False Or (modify.InstGadgets = True And Not FileIO.FileSystem.FileExists(ProgramFiles & "\Windows Sidebar\8GadgetPack.exe")) Then
        ...
        If modify.MenuChAddBarStyle = True Then
            If modify.AddressBarStyle = "blue" Then
            ...
            ElseIf modify.AddressBarStyle = "white" Then
        ...
        If modify.Language = "en-US" Then
            ActionLabel.Text = "Finalizing modifications..."
        ElseIf modify.Language = "en-GB" Then
            ActionLabel.Text = "Finalising modifications..."
        End If
        ActionLabel.Refresh()
        If modify.IsRestartNeeded = False And modify.IsThemeChangeNeeded = True Then
            Me.TopMost = True
            If modify.InstallSoundsChecked = True Or modify.InstSounds = True Then
                ...
                End With
                Wait(5)
            ElseIf modify.InstallSoundsChecked = False And modify.InstSounds = False Then
                Dim ThemeChangeProcess As New Process
                With ThemeChangeProcess
            ...
            End If
            Me.TopMost = False
        ElseIf modify.IsRestartNeeded = True And modify.IsThemeChangeNeeded = True Then
            ' \If theme changed or change UXTheme patcher then autostart theme change after reboot
        ...
        ElseIf IsFinished = True Then
            If e.CloseReason = CloseReason.UserClosing = True Then
                If modify.IsRestartNeeded = True Then
                    ...
                    If modify.InstQuero = False And modify.ChangeQueroChecked = True Then
                    ...
                    If MessageBox.Show("You need to restart your system to finish the modification(s). Do you want to restart now?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = DialogResult.Yes Then
                    ...
                    ElseIf DialogResult.No Then
                        modify.Close()
                    End If
                ElseIf modify.IsRestartNeeded = False Then
                    If modify.ChangeQueroChecked = True And FileIO.FileSystem.DirectoryExists(ProgramFiles & "\Quero Toolbar") Then
                        Dim ProgDir As String = ProgramFiles & "\Windows8.1to8RPConv"
                        Dim ResFolder As String = ProgDir & "\res"
